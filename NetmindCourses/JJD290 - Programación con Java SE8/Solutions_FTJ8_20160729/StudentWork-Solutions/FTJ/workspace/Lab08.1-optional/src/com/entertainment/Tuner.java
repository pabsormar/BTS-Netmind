 ...
 *
 * Its set of methods is very simple (just setting the channel) but internally
 * it contains complex functionality - making it ideal to encapsulate in its own class 
 * The functionality we include doesn't do any actual tuner-related work.  It is illustrative only
 *
 */
